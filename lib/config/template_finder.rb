class ActionView::TemplateFinder
  ...
  def find_generic_base_path_for_with_export(template_file_name, extension)
    generic_base_path = find_generic_base_path_for_without_export(template_file_name, extension)
  ...
  alias_method_chain :find_generic_base_path_for, :export
